...
const socialLinks = [
  ...
  {
    label: "Website",
    href: "https://my-portfolio-teal-pi-68.vercel.app/",
    icon: (props: { className?: string }) => (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold text-white">Fresh Cart</h2>
                <p className="text-sm text-zinc-400">
                  Your everyday essentials, delivered.
                </p>
              </div>
            </div>
            <p className="max-w-md text-sm leading-6 text-zinc-400">
              Discover curated products, fast delivery, and a shopping
              experience designed to feel effortless from first click to final
              checkout.
            </p>
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2 text-zinc-400">
                <Mail className="h-4 w-4 text-amber-400" />
                <span>abdelrahman.ibrahiem.elshiekh@gmail.com</span>
              </div>
              <div className="flex items-center gap-2 text-zinc-400">
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-white/5 text-zinc-300 transition hover:border-amber-400/40 hover:bg-amber-400/10 hover:text-white"
