...
import { BrandItem } from "@/app/brands/brand-fetch-response.interface";
...
export default async function BrandDetailPage({ params }: PageProps) {
  ...
  const brand: BrandItem | undefined = json?.data;
          ...
          <div className="space-y-4 p-6">
            ...
            <div className="grid gap-4 text-sm text-zinc-300">
              <div className="rounded-3xl border border-zinc-800 bg-zinc-950/90 p-4">
                ...
                <p className="mt-2 text-base font-semibold text-white">{brand.name}</p>
              </div>
              <div className="rounded-3xl border border-zinc-800 bg-zinc-950/90 p-4">
                <p className="text-xs uppercase tracking-[0.24em] text-zinc-500">slug</p>
                <p className="mt-2 text-base font-semibold text-white">{brand.slug}</p>
              </div>
              <div className="rounded-3xl border border-zinc-800 bg-zinc-950/90 p-4">
                <p className="text-xs uppercase tracking-[0.24em] text-zinc-500">createdAt</p>
                <p className="mt-2 text-base font-semibold text-white">{brand.createdAt}</p>
              </div>
              <div className="rounded-3xl border border-zinc-800 bg-zinc-950/90 p-4">
                <p className="text-xs uppercase tracking-[0.24em] text-zinc-500">updatedAt</p>
                <p className="mt-2 text-base font-semibold text-white">{brand.updatedAt}</p>
              </div>
            </div>
          </div>
        </Card>
